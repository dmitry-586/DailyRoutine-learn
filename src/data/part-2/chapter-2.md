# Глава 7. Современная экосистема CSS
...
Дальше мы перейдём к инструментам, которые окружают CSS на уровне сборки: препроцессоры, PostCSS, оптимизация и вычищение стилей. Это поможет понять, как превратить теорию про современные возможности CSS в реально быстрый и управляемый продакшн-код.
