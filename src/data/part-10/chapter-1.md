# Глава 33. Алгоритмические задачи для фронтенда
...
## 30.1. Какие задачи дают фронтендерам
...
## 30.3. Структурированный подход к решению
...
## 30.5. Асинхронные и фронтенд‑специфичные задачи
...
## 30.6. Как тренироваться эффективно
