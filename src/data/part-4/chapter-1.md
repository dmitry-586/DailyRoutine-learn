# Глава 13. NPM, package.json и зависимости проекта
...
## 13.2. package.json: сердце проекта
...
## 13.3. SemVer (Semantic Versioning)
...
## 13.5. Скрипты и lifecycle hooks
...
В следующей главе мы разберёмся со сборщиками: посмотрим, как Webpack, Vite и другие инструменты превращают исходный код в оптимизированный бандл и какие решения при этом остаются за разработчиком.
