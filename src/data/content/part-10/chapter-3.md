...
## 29.1. Что должен знать Junior (и как это проверить)
...
## 29.3. Типичные ошибки кандидатов (и как их избежать)
...
## 29.4. Как использовать этот чек-лист
