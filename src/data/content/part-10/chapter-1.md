# Глава 27. Алгоритмические задачи для фронтенда
...
## 27.1. Какие задачи дают фронтендерам
...
## 27.3. Структурированный подход к решению
...
## 27.5. Асинхронные и фронтенд‑специфичные задачи
...
## 27.6. Как тренироваться эффективно
