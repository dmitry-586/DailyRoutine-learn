# Глава 20. Архитектура больших приложений
...
## 20.1. Redux Toolkit: современный способ работы с Redux
...
## 20.2. Альтернативные state-менеджеры
...
## 20.3. TanStack Query: управление server state
...
## 20.4. Архитектурные паттерны React
...
## 20.5. SolidJS: альтернативный взгляд на реактивность

SolidJS — современный UI‑фреймворк, который по синтаксису очень похож на React (JSX, компоненты), но под капотом использует **сигналы и fine‑grained реактивность**, а не Virtual DOM.

### Ключевые отличия от React

**React:**

- использует Virtual DOM и diffing;
- при изменении состояния компонент перерендеривается полностью;
...
- как альтернатива для проектов, где важна максимальная производительность и мелкозернистый контроль обновлений;
...
- объяснить ключевые отличия SolidJS от React и зачем это знать.

Если это получается связно, ты понимаешь архитектурные подходы и можешь выбрать правильный инструмент для задачи.

---

## 20.7. Практические задания

### Задание 1: Выбор state manager
...
### Задание 3: TanStack Query с мутациями
...
### Задание 6: Миграция с Context на Redux
