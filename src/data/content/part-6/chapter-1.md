...
## 18.1. Virtual DOM и Fiber: как React обновляет интерфейс
...
## 18.2. JSX и элементы: синтаксический сахар над JavaScript
...
## 18.3. Компоненты и пропсы: строительные блоки React
...
## 18.4. Отрисовка и reconciliation: что происходит при изменении состояния
...
## 18.6. Мини‑самопроверка по главе
