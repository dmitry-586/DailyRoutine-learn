...
## 18.4. Отрисовка и reconciliation
...
В следующей главе мы разберём более продвинутые паттерны и подходы в React: кастомные хуки, контекст, состояния в сложных экранах и то, как не утонуть в связях между компонентами.
