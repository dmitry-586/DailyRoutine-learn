...
В следующей главе мы перейдём от абстрактной механики к очень конкретной области — работе с DOM: это тот мост между JavaScript и реальным интерфейсом, через который проходят практически все пользовательские взаимодействия.
