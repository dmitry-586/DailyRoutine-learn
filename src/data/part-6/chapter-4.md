# Глава 24. Архитектура больших React-приложений
...
- Используйте **TanStack Query** (см. главу 26)
...
- Используйте **Zustand** (см. главу 27)
...
Для сложных форм используйте **React Hook Form** (см. главу 24).
