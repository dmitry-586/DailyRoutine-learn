# Глава 27. SSR и современный React-стек
...
## 29.1. Проблемы классического SPA
...
## 29.2. SSR (Server-Side Rendering): рендеринг на сервере
...
## 29.3. Next.js: стандарт для SSR/SSG в React
...
## 29.4. Server Components: новый этап React
...
## 29.5. Код-сплиттинг и оптимизация бандла
...
## 29.6. Мини‑самопроверка по главе
