# Глава 43. Тестирование: unit, integration, e2e, стратегии
...
## 43.1. Виды тестов: Unit, Integration, E2E
...
- изолированы от внешних зависимостей
 ...
 Не ловят ошибки интеграции. Тестируют только логику в изоляции.
...
## 43.3. Testing Library: тестирование компонентов
...
5. `getByTestId` — крайний случай (когда нет других способов)
 ...
 `getByTestId` — крайний случай. Используйте только если нет семантических способов.
...
**Правило:** Много быстрых unit-тестов, меньше integration, минимум E2E.
...
- UI без поведения
- Когда тест дороже поддержки
- Генерация кода

---

## 43.7. Частые ошибки в тестировании
...
**Важно:** Coverage — метрика, а не самоцель. 100% coverage не гарантирует отсутствие багов.

---

## 43.9. Организация тестов
...
Unit — одна функция/модуль в изоляции (быстро, дешево). Integration — взаимодействие модулей (медленнее). E2E — полный пользовательский сценарий (медленно, дорого, но надёжно).
