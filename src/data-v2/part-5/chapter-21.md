...
- Execution Context создаётся при выполнении кода и включает Lexical Environment и `this`
- Lexical Environment хранит переменные и ссылку на внешнее окружение
- Call Stack управляет выполнением кода по принципу LIFO
- Замыкания — это функции, которые сохраняют доступ к переменным внешней области видимости
- Замыкания хранят ссылку, а не копию переменной
- Замыкания используются для инкапсуляции, приватности, мемоизации
- Понимание замыканий критично для работы с асинхронностью и React
