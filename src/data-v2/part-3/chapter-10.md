...
- Правильная иерархия заголовков критична для SEO
- Нативные элементы лучше кастомных div'ов
- Семантика улучшает SEO, UX, доступность и производительность
- SPA-фреймворки требуют ещё большего внимания к семантике
- WHATWG HTML — живой стандарт, который нужно знать
