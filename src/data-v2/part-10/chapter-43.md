...
### Fiber: внутренний планировщик React

**Fiber** — это внутренняя архитектура React, которая пришла на смену старому стековому алгоритму в React 16. Представь Fiber как внутреннего планировщика, который умеет ставить тяжёлые задачи на паузу, чтобы пользователь не чувствовал фризов при вводе данных.
