...
- TCP — надёжный, но медленный из-за handshake
- UDP — быстрый, но без гарантий доставки
- QUIC (HTTP/3) объединяет скорость UDP с надёжностью TCP
- RTT критично влияет на производительность, особенно на мобильных сетях
- Оптимизации (0-RTT, keep-alive) уменьшают количество handshake
