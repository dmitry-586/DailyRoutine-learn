...
- Протокол: собственный (начинается с HTTP)
- Типы данных: текст и бинарные
- Переподключение: нужно реализовывать вручную
- Сложность: выше
- Overhead: меньше (после handshake)
- Поддержка браузеров: хорошая
- Использование: чат, игры, коллаборация

**SSE:**

- Направление: одностороннее (сервер → клиент)
- Протокол: HTTP
- Типы данных: только текст
- Переподключение: автоматическое
- Сложность: ниже
- Overhead: больше (HTTP заголовки)
- Поддержка браузеров: хорошая (кроме IE)
- Использование: уведомления, мониторинг
