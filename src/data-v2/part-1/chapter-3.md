...
- Правильное использование методов критично для REST API
- Идемпотентность важна для надёжности и кэширования
- Коды состояния помогают правильно обрабатывать ответы
