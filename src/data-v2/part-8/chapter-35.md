...
- `interface` для объектов, классов, публичных API, расширяемости
- `type` для union, intersection, mapped types, утилит
- Declaration merging работает только для `interface`
- `type` более гибкий для композиций
- Выбор зависит от конкретной задачи
- Понимание различий критично для правильного проектирования типов
