...
- Utility Types предоставляют готовые утилиты для работы с типами
- Discriminated Unions для точного определения типов через дискриминант
- Type Guards для сужения типов в условных блоках
- Conditional Types для выбора типов на основе условий
- Mapped Types для создания новых типов на основе существующих
- Template Literal Types для генерации типов из строковых шаблонов
- Рекурсивные типы для работы с вложенными структурами
