...
| Метод | Возвращает | Производительность | Использование |
|-------|-----------|-------------------|---------------|
| `getElementById` | Element или null | Самый быстрый | Когда есть id |
| `querySelector` | Element или null | Медленнее | Универсальный селектор |
| `querySelectorAll` | NodeList | Медленнее | Множественные элементы |
...
- DOM операции дорогие — минимизируйте их количество
- DocumentFragment для массовой вставки
- Избегайте layout thrashing: сначала чтения, потом записи
- Кэшируйте элементы и значения layout‑свойств
- Используйте textContent вместо innerHTML для пользовательских данных
- requestAnimationFrame для анимаций
- Понимание производительности DOM критично для быстрых интерфейсов
