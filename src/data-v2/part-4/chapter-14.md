...
- relative создаёт контекст для absolute элементов
- fixed всегда относительно viewport
- sticky — мощный инструмент для липких элементов
- z-index работает только в рамках контекста наложения
- Float устарел, использовать Flexbox/Grid
