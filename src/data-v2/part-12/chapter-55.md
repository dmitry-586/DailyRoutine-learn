...
| Тип | Когда рендерится        | Производительность | Актуальность данных      | SEO | Нагрузка на сервер |
| --- | ----------------------- | ------------------ | ------------------------ | --- | ------------------ |
| SSR | На каждый запрос        | Медленнее          | Всегда актуальные        | ✅  | Высокая            |
| SSG | На этапе билда          | Быстрее всего      | Могут устареть           | ✅  | Нет                |
| ISR | На билде + периодически | Быстро             | Обновляются периодически | ✅  | Низкая             |
| CSR | На клиенте              | Зависит от сети    | Зависит от запросов      | ❌  | Нет                |
...
- SPA имеет проблемы с SEO и медленной первой загрузкой
- SSR решает проблемы SEO, но требует сервер
- SSG максимально быстрый, но данные могут устареть
- ISR баланс между производительностью и актуальностью
- CSR для интерактивных частей, не критичных для SEO
- Выбор стратегии зависит от требований проекта
